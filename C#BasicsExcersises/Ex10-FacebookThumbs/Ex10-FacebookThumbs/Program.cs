...
namespace Ex10_FacebookThumbs
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Give me your friends name or type 'Enter' to exit:");
            while(true)
            {
                ...
                Console.WriteLine("Give me another friends name or type 'Enter' to exit:");
            }
